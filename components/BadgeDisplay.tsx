...
const badgeStyles: Record<Badge['type'], { icon: React.ReactElement<{ className?: string }>; colors: string }> = {
    verified: {
        ...
        colors: 'bg-gradient-primary text-white border-spinny-orange',
    },
    top_seller: {
        ...
        colors: 'bg-spinny-blue text-spinny-text-dark dark:bg-spinny-blue dark:text-spinny-text-dark border-amber-500/50',
    },
    high_rating: {
        ...
        colors: 'bg-spinny-orange-light text-spinny-orange dark:bg-spinny-orange dark:text-spinny-orange border-spinny-orange/50',
    }
};
