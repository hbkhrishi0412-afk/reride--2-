...
const badgeStyles: Record<Badge['type'], { icon: React.ReactElement<{ className?: string }>; colors: string }> = {
    verified: {
        ...
        colors: 'bg-gradient-primary text-white border-brand-turquoise',
    },
    top_seller: {
        ...
        colors: 'bg-brand-mint text-brand-text-dark dark:bg-brand-mint dark:text-brand-text-dark border-amber-500/50',
    },
    high_rating: {
        ...
        colors: 'bg-brand-turquoise-light text-brand-turquoise dark:bg-brand-turquoise dark:text-brand-turquoise border-brand-turquoise/50',
    }
};
