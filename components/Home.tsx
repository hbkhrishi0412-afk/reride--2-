    ...
    return (
      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-3 right-3">
            <button
              ...
              style={{
                backgroundColor: isInWishlist ? 'var(--brand-turquoise)' : 'white',
                color: isInWishlist ? 'white' : 'var(--brand-text-dark)'
              }}
              onMouseEnter={(e) => !isInWishlist && (e.currentTarget.style.backgroundColor = 'var(--brand-mint-light)')}
        ...
        <div className="p-4">
          ...
          <p className="text-sm text-brand-text-dark mb-3">{vehicle.variant}</p>
          ...
          {/* Price */}
          <div className="flex justify-between items-center pt-4 border-t border-brand-mint">
            <div>
            ...
            <button 
              ...
              onMouseLeave={(e) => e.currentTarget.style.color = 'var(--brand-turquoise)'}
            >
              View
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <>
            ...
            <section className="spinny-hero">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl mb-8" style={{ color: 'var(--brand-mint)' }}>
                        200+ Quality Checks • Fixed Price • 5-Day Money Back
                    </p>
                    
                    {/* Search Bar */}
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-brand-white rounded-2xl p-2 shadow-lg">
                            <div className="flex flex-col md:flex-row gap-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 text-brand-text-dark border-0 focus:outline-none rounded-xl"
                                />
                                <button 
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
                        <div className="spinny-trust-badge">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" style={{ color: 'var(--brand-mint)' }}>
            ...
            <section className="py-16 bg-brand-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="spinny-section-header" style={{ color: 'var(--brand-text-dark)' }}>Featured Cars</h2>
                        <button 
            ...
            <section className="py-16 bg-brand-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="spinny-section-header text-center mb-8" style={{ color: 'var(--brand-text-dark)' }}>
                        Browse by Category
                    </h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {Object.values(CategoryEnum).map((category) => (
                            ...
                            >
                                <div className="mb-4" style={{ color: 'var(--brand-mint)' }}>
                                    {categoryIcons[category]}
                                </div>
                                <h3 className="font-semibold" style={{ color: 'var(--brand-text-dark)' }}>
                                    {category.replace('_', ' ')}
                                </h3>
                            </button>
                        ))}
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                    <div className="absolute top-20 left-20 w-32 h-32 rounded-full opacity-20 animate-float" style={{ background: 'var(--brand-mint-light)' }}></div>
                    <div className="absolute bottom-20 right-20 w-24 h-24 bg-brand-turquoise rounded-full opacity-20 animate-float" style={{animationDelay: '1s'}}></div>
                </div>
            </section>
            ...
            {recommendations.length > 0 && (
                 <section className="py-20 bg-brand-white relative overflow-hidden">
                    ...
                    {/* Background decorative elements */}
                    <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-20 animate-float" style={{ background: 'radial-gradient(circle, var(--brand-mint-light), var(--brand-mint-light))' }}></div>
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-brand-white to-brand-mint rounded-full opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
                </section>
            )}
            ...
            <section className="py-16 bg-brand-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-center mb-12 text-brand-text-dark">Featured Collection</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {recentlyViewed.length > 0 && (
             ...
             {/* Seller CTA */}
            <section style={{ background: 'linear-gradient(to right, var(--brand-mint-light), var(--brand-gray))' }} className="dark:bg-gradient-dark">
                <div className="container mx-auto px-4 py-20 text-center scroll-animate">
                    ...
                    <p className="max-w-2xl mx-auto mb-8 text-brand-gray-600 dark:text-brand-text-dark">Join the most advanced vehicle marketplace today. Reach thousands of buyers and use our AI tools to sell faster.</p>
