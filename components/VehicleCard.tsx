      ...
      <div className="relative overflow-hidden">
        ...
        {vehicle.isFeatured && (
         ...
         <div className="absolute top-3 right-3 flex items-center gap-2 z-10">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 transition-colors" style={{ color: isInWishlist ? 'var(--brand-rose-pink)' : 'white' }} viewBox="0 0 20 20" fill="currentColor">
