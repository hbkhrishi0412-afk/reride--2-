      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-2 flex justify-between items-end">
             ...
             <div className="flex items-center gap-2">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 transition-colors ${isInWishlist ? 'text-brand-deep-red' : 'text-brand-gray-400'}`} viewBox="0 0 20 20" fill="currentColor">
