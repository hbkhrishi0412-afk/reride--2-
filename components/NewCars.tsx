...
const CarModelCardSkeleton: React.FC = () => (
    <div className="bg-brand-white dark:bg-brand-gray-800 rounded-xl shadow-soft p-4 animate-pulse">
...
const CarModelCard: React.FC<{ car: NewCarModel; isExpanded: boolean; onToggle: (id: number) => void; selectedState: string; onViewSpecs: (car: NewCarModel, variant: NewCarVariant) => void; }> = ({ car, isExpanded, onToggle, selectedState, onViewSpecs }) => (
    <div className="bg-brand-white dark:bg-brand-gray-800 rounded-xl shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-soft-lg">
        <button
            ...
            <div className="px-4 pb-4 animate-fade-in">
                <div className="border-t border-brand-gray-200 dark:border-brand-gray-700 pt-4 overflow-x-auto">
                    <table className="min-w-full divide-y divide-brand-gray-200 dark:divide-brand-gray-700">
                        ...
                        <tbody className="bg-brand-white dark:bg-brand-gray-800 divide-y divide-brand-gray-200 dark:divide-brand-gray-700">
...
const FilterSelect: React.FC<{ label: string; value: string; onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void; children: React.ReactNode, disabled?: boolean }> = ({ label, value, onChange, children, disabled = false }) => (
    <div>
        ...
        <select value={value} onChange={onChange} disabled={disabled} className="w-full p-3 border border-brand-gray-300 dark:border-brand-gray-600 rounded-lg focus:outline-none bg-brand-white dark:bg-brand-gray-700 text-brand-gray-800 dark:text-brand-gray-200 disabled:opacity-50 disabled:cursor-not-allowed" onFocus={(e) => !disabled && (e.currentTarget.style.boxShadow = '0 0 0 2px var(--brand-deep-red-light)')} onBlur={(e) => e.currentTarget.style.boxShadow = ''}>
            {children}
        </select>
    </div>
);
        ...
        <div className="new-cars container mx-auto px-4 py-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8">
                ...
                <aside className="hidden lg:block self-start sticky top-24">
                    <div className="bg-brand-white dark:bg-brand-gray-800 p-6 rounded-xl shadow-soft-lg space-y-4">
                ...
                <main className="space-y-6">
                    <input
                        ...
                        className="w-full p-4 border border-brand-gray-300 dark:border-brand-gray-600 rounded-xl focus:outline-none bg-brand-white dark:bg-brand-gray-700 text-brand-gray-800 dark:text-brand-gray-200 text-lg" onFocus={(e) => { e.currentTarget.style.borderColor = 'var(--brand-deep-red)'; e.currentTarget.style.boxShadow = '0 0 0 2px var(--brand-deep-red-light)'; }} onBlur={(e) => { e.currentTarget.style.borderColor = ''; e.currentTarget.style.boxShadow = ''; }}
                    />
                    <div className="flex justify-between items-center">
                        <button onClick={handleOpenFilterModal} className="lg:hidden flex items-center gap-2 font-semibold px-4 py-2 rounded-lg" style={{ color: 'var(--brand-deep-red)', background: 'var(--brand-orange-light)' }} onMouseEnter={(e) => e.currentTarget.style.background = 'var(--brand-orange)'} onMouseLeave={(e) => e.currentTarget.style.background = 'var(--brand-orange-light)'}>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                        {isLoading ? (
                            ...
                            <div className="xl:col-span-2 text-center py-16 bg-brand-white dark:bg-brand-gray-800 rounded-xl shadow-soft">
