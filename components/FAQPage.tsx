    ...
    <div className="animate-fade-in container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        <input
          ...
          className="w-full p-4 border border-brand-gray-300 dark:border-brand-gray-600 rounded-xl focus:outline-none bg-white dark:bg-brand-gray-700 text-lg" onFocus={(e) => { e.currentTarget.style.borderColor = 'var(--brand-deep-red)'; e.currentTarget.style.boxShadow = '0 0 0 2px var(--brand-deep-red-light)'; }} onBlur={(e) => { e.currentTarget.style.borderColor = ''; e.currentTarget.style.boxShadow = ''; }}
        />
      </div>
